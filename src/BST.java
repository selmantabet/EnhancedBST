 ...
 *                     
 * Augmentation for HW3 by Selmane Tabet - 210004050
 * BST Implementation by V.S.Adamchik @ CMU. Augmented for HW3 @ CPEG 330 HBKU
 * Retrieved from https://www.cs.cmu.edu/~adamchik/15-121/lectures/Trees/code/BST.java
 * Retrieval date and time: 3/22/2019 3:50 AM
 * 
 * Changelog:
 *  - Added postOrder traversal into BST implementation.
 *  - User interactivity.
 *  - Height/max/min measurements.
 *****************************************************************************/
...
public class BST <T extends Comparable<T>> implements Iterable<T>
{
   public static void main(String[] args)
   {
      ...
      Integer numNodes = scn.nextInt(); //number of nodes

      Integer i = 1; //set at 1 for legibility  on prompt print. While loop guard adjusted.
      while(i <= numNodes) {
    	  System.out.print("Enter value of node #"+i+": ");
    	  Integer k = new Integer(scn.nextInt());
    	  bst.insert(k);
    	  i++;
      }
      System.out.println();
      Node<Integer> pMax = bst.root; //taking root node
      int maxDepth = 0; //depth counter initialized and will iterate until leaf.
      while (pMax.right != null) {
    	  pMax = pMax.right;
    	  maxDepth++;
      }
      System.out.println("The maximum value is "+pMax.data+" at depth "+maxDepth+".");
      
      
      Node<Integer> pMin = bst.root; //same method for maxDepth, just in a different direction.
      int minDepth = 0;
      ...
      System.out.println("The minimum value is "+pMin.data+" at depth "+minDepth+".");
